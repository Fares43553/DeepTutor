...
function SettingsPageContent() {
  ...
  const persistUi = async (nextTheme: "light" | "dark" | "glass" | "snow", nextLanguage: "en" | "zh" | "ar") => {
  ...
  const updateLanguage = async (nextLanguage: "en" | "zh" | "ar") => {
